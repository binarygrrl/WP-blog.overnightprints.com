...
<div class="article"><?php if ( have_comments() ) : ?>
...
<div id="respond" class="article">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<div id="comments"><textarea name="comment" id="comment" cols="55%" rows="10" tabindex="4"></textarea>

		<div id="submit"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" /></div>
