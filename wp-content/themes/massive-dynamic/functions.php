...
function custom_login_logo() {
    echo '<style type="text/css">
        h1 a { background-image:url(/wp-content/uploads/2016/08/ONP_stacked.png) !important; height: 122px !important; background-size: 100px auto; }
    </style>';
}
