...
function pixflow_sc_blog_masonry( $atts, $content = null ){
    ...
    $arrg = array(
        ...
        'posts_per_page' => -1,//$blog_post_number,
            ...
            <div class="blog-masonry-content">
                ...
                <!-- <p class="blog-excerpt"> <?php //echo mb_substr(get_the_excerpt(), 0,150).$subStr; ?></p> -->
                  ...
                  <p class="blog-excerpt"> <?php 
                    ...
                    $excerpt = mb_substr(get_the_excerpt(), 0,150).$subStr;
                    $readmore = '<a style="clear: both;" href="<?php the_permalink(); ?>">Read More</a>';
                    echo $excerpt.$readmore;
                    //$excerpt = apply_filters('the_excerpt',strip_shortcodes(get_the_content(esc_attr__('Read more', 'massive-dynamic').'<i class="px-icon icon-arrow-right2"></i>')));
                    //echo mb_substr(get_the_excerpt(), 0,150).$subStr; 
