...
function pixflow_customizer_settings($controls)
{
    ...
    $controls[] = array(
        'type' => 'description',
        'default' => __('After entering your purchase code, you should save it using "Save & View" button (that is placed on top of your work space), and then you can import demo websites.<br /><br /><a href="http://support.pixflow.net/knowledge-base/how-to-find-your-purchase-code/" target="_blank">Learn more</a>','massive-dynamic'),
